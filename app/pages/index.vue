...
<template>
  <div>
    <header class="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden bg-slate-950">
      ...
      <div class="absolute inset-0 bg-linear-to-b from-transparent via-slate-950/40 to-slate-50 pointer-events-none z-0"></div>

      <div class="max-w-7xl mx-auto px-6 md:px-8 relative z-10 w-full mt-24 lg:mt-20 grid lg:grid-cols-12 gap-12 items-center pointer-events-none">
        
        <div class="lg:col-span-7 pt-12 md:pt-0 pointer-events-auto">
          <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-500/10 border border-teal-500/30 text-teal-300 text-xs font-bold uppercase tracking-widest mb-8 backdrop-blur-md">
          ...
          <h2 class="text-4xl md:text-6xl lg:text-7xl font-black text-white leading-[1.05] mb-6 tracking-tight">
            Garantizando el acceso a <span class="text-transparent bg-clip-text bg-linear-to-r from-teal-400 to-blue-500">medicamentos de alta calidad</span>
          </h2>
          ...
          <div class="flex flex-col sm:flex-row gap-5">
            <button class="bg-linear-to-r from-teal-500 to-blue-600 hover:from-teal-400 hover:to-blue-500 text-white px-8 py-4 rounded-full text-base font-bold transition-all shadow-[0_0_20px_rgba(20,184,166,0.3)] hover:shadow-[0_0_30px_rgba(20,184,166,0.5)] flex items-center justify-center gap-3">
              Explorar Productos <LucideArrowRight :size="18" />
            </button>
            <button class="bg-transparent hover:bg-white/5 border border-slate-600 text-white px-8 py-4 rounded-full text-base font-medium transition-all flex items-center justify-center">
              Portal Médico
            </button>
          </div>
        </div>

        <div class="lg:col-span-5 relative hidden md:block pointer-events-auto transform hover:-translate-y-2 transition-transform duration-500 mt-10 lg:mt-0">
           <div class="w-full h-96 lg:h-112.5 rounded-4xl overflow-hidden shadow-2xl relative border border-white/10 group">
              <div class="absolute inset-0 bg-[url('/HERO-IMAGEN.jpeg')] bg-cover bg-center opacity-40 mix-blend-luminosity group-hover:opacity-60 transition-opacity duration-700"></div>
              <div class="absolute inset-0 bg-linear-to-t from-slate-900 via-slate-900/60 to-transparent"></div>
              
              <div class="absolute -top-10 -right-10 w-40 h-40 bg-teal-500 rounded-full mix-blend-screen filter blur-[60px] opacity-40"></div>
              
              <div class="absolute bottom-6 left-6 right-6 flex flex-col gap-3">
                <div class="bg-slate-900/80 backdrop-blur-md p-4 rounded-2xl border border-white/10 shadow-lg flex items-center gap-4">
                  <div class="p-2.5 bg-teal-500/20 text-teal-400 border border-teal-500/30 rounded-xl"><LucideSnowflake :size="22" /></div>
                  <div>
                ...
                <div class="bg-slate-900/80 backdrop-blur-md p-4 rounded-2xl border border-white/10 shadow-lg flex items-center gap-4">
                  <div class="p-2.5 bg-blue-500/20 text-blue-400 border border-blue-500/30 rounded-xl"><LucideFileCheck :size="22" /></div>
                  <div>
    ...
    <section id="nosotros" class="py-32 bg-slate-50 relative z-20 overflow-hidden">
      <div class="absolute top-0 right-0 w-full h-full overflow-hidden pointer-events-none opacity-40">
        <div class="absolute top-[-20%] right-[-10%] w-[70%] h-[70%] bg-teal-100/50 rounded-full blur-3xl mix-blend-multiply"></div>
        <div class="absolute top-[40%] left-[-10%] w-[50%] h-[50%] bg-blue-100/50 rounded-full blur-3xl mix-blend-multiply"></div>
      </div>
      ...
      <div class="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        <div class="grid lg:grid-cols-12 gap-16 items-start">
          ...
          <div class="lg:col-span-5 lg:sticky lg:top-32">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-slate-200 text-teal-600 text-xs font-bold uppercase tracking-widest mb-6 shadow-sm">
          ...
          <div class="lg:col-span-7 space-y-8">
            <div class="bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-white hover:-translate-y-2 transition-transform duration-500 group">
              <div class="flex flex-col sm:flex-row gap-8 items-start">
                <div class="w-20 h-20 shrink-0 bg-blue-50 rounded-3xl flex items-center justify-center text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-500 shadow-inner">
            ...
            <div class="bg-slate-950 p-8 md:p-10 rounded-[2.5rem] shadow-2xl border border-slate-800 hover:border-teal-500/30 hover:-translate-y-2 transition-all duration-500 relative overflow-hidden group">
              <div class="absolute top-0 right-0 w-64 h-64 bg-teal-500/10 rounded-full blur-3xl group-hover:bg-teal-500/20 transition-colors"></div>
              <div class="flex flex-col sm:flex-row gap-8 items-start relative z-10">
                <div class="w-20 h-20 shrink-0 bg-slate-900 border border-slate-800 rounded-3xl flex items-center justify-center text-teal-400 group-hover:scale-110 transition-transform duration-500">
                ...
                <div>
                  ...
                  <p class="text-slate-400 leading-relaxed text-lg font-light">
                    Ser reconocidos no solo como el principal importador de la región, sino como el <span class="text-teal-400 font-medium">socio estratégico número uno</span> del sector médico público y privado, redefiniendo la confiabilidad en la cadena de suministro en salud.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-white hover:-translate-y-2 transition-transform duration-500 group">
              <div class="flex flex-col sm:flex-row gap-8 items-start">
                <div class="w-20 h-20 shrink-0 bg-teal-50 rounded-3xl flex items-center justify-center text-teal-600 group-hover:bg-teal-600 group-hover:text-white transition-colors duration-500 shadow-inner">
                ...
                <div class="w-full">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="bg-slate-50 p-4 rounded-2xl flex items-center gap-3 border border-slate-100">
                      <div class="w-8 h-8 rounded-full bg-white shadow-sm flex items-center justify-center text-teal-500 font-bold text-xs">01</div>
                      <span class="font-semibold text-slate-700">Calidad Absoluta</span>
                    </div>
                    <div class="bg-slate-50 p-4 rounded-2xl flex items-center gap-3 border border-slate-100">
                      <div class="w-8 h-8 rounded-full bg-white shadow-sm flex items-center justify-center text-teal-500 font-bold text-xs">02</div>
                      <span class="font-semibold text-slate-700">Innovación</span>
                    </div>
                    <div class="bg-slate-50 p-4 rounded-2xl flex items-center gap-3 border border-slate-100">
                      <div class="w-8 h-8 rounded-full bg-white shadow-sm flex items-center justify-center text-teal-500 font-bold text-xs">03</div>
                      <span class="font-semibold text-slate-700">Integridad</span>
                    </div>
                    <div class="bg-slate-50 p-4 rounded-2xl flex items-center gap-3 border border-slate-100">
                      <div class="w-8 h-8 rounded-full bg-white shadow-sm flex items-center justify-center text-teal-500 font-bold text-xs">04</div>
      ...
      <div class="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div class="max-w-2xl">
            ...
            <p class="text-slate-400 text-lg font-light leading-relaxed">Representación exclusiva de laboratorios de clase mundial. Fármacos aprobados bajo los más rigurosos estándares internacionales de farmacopea.</p>
          </div>
        ...
        <div class="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div class="order-2 lg:order-1 relative">
             <div class="relative h-125 rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] group">
                <div class="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1582719471384-894fbb16e074?q=80&w=1000&auto=format&fit=crop')] bg-cover bg-center opacity-50 mix-blend-luminosity group-hover:opacity-70 transition-opacity duration-700 group-hover:scale-105 transform"></div>
                ...
                <div class="absolute bottom-8 left-8 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-xl max-w-50">
          ...
          <div class="order-1 lg:order-2">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/30 text-blue-400 text-xs font-bold uppercase tracking-widest mb-6">
              Infraestructura Asegurada
            </div>
            <h3 class="text-4xl md:text-5xl font-black mb-6 leading-tight">Excelencia en cada eslabón de la <span class="text-teal-400">cadena logística.</span></h3>
            ...
            <div class="space-y-8">
              <div class="flex gap-5 group">
                <div class="shrink-0 mt-1 w-12 h-12 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center text-teal-400 group-hover:bg-teal-500 group-hover:text-white transition-colors duration-300">
                  <LucideSnowflake :size="24"/>
                </div>
                <div>
                  <h4 class="font-bold text-xl text-white mb-2">Cadena de Frío Garantizada</h4>
                  <p class="text-slate-400 leading-relaxed">Monitoreo ininterrumpido de temperatura durante el almacenamiento, transporte e importación, validado con dataloggers.</p>
                </div>
              </div>
              
              <div class="flex gap-5 group">
                <div class="shrink-0 mt-1 w-12 h-12 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center text-blue-400 group-hover:bg-blue-500 group-hover:text-white transition-colors duration-300">
                  <LucideActivity :size="24"/>
                </div>
                <div>
                  <h4 class="font-bold text-xl text-white mb-2">Experiencia Aduanera Integral</h4>
                  <p class="text-slate-400 leading-relaxed">Gestión ágil y especializada de la internación y despacho aduanero, evitando demoras críticas para medicamentos de urgencia.</p>
                </div>
              </div>
              ...
              <div class="flex gap-5 group">
                ...
                <div>
                  ...
                  <p class="text-slate-400 leading-relaxed">Aval gubernamental estricto. Todos nuestros productos cuentan con registro sanitario vigente y trazabilidad documental completa.</p>
                </div>
              </div>
            </div>
          </div>
