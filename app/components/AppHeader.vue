  ...
  <header>
    <div
      ...
      <div class="flex gap-6">
        <a href="mailto:biadoxidpharma@outlook.com"
          class="flex items-center gap-1 hover:text-teal-400 transition-colors cursor-pointer">
    ...
    <nav :class="[
      ...
      <div :class="[
        ...
        <div class="hidden lg:flex items-center gap-8 text-sm font-semibold text-slate-300">
          <NuxtLink to="/" class="hover:text-teal-400 transition-colors pb-1"
            active-class="text-white border-b-2 border-teal-500">
            Inicio
          </NuxtLink>
          <NuxtLink to="/nosotros" class="hover:text-teal-400 transition-colors pb-1"
            active-class="text-white border-b-2 border-teal-500">
            Identidad
          </NuxtLink>
